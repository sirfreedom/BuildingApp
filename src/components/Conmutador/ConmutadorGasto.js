...
export class ConmutadorGasto extends React.Component {
    constructor(props) {
        ...
        GastoService.listarFormasDePagoGasto((data) => this.setState({ tiposFormaDePagoGasto: data }));
        ...
        return (
            <Fragment>
                ...
                >
                    ...
                    <Column dataField="tipoFormaDePagoGastoId" caption="Forma de Pago Predeterminada" dataType={"number"} allowEditing={true}>
                        <Lookup dataSource={() => this.state.tiposFormaDePagoGasto} valueExpr={'id'} displayExpr={'descripcion'} />
                        <RequiredRule />
                    </Column>
