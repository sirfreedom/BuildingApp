...
export class ConmutadorAdministrador extends React.PureComponent {
    ...
    firmaEditRender(e) {
        return <ImageUploader accept={".jpeg,.jpg,.png,.gif"} rowData={e} mimeType={e.data.imagenFirma ? e.data.imagenFirma.mimeType : "image/jpeg"} base64={e.data.imagenFirma && e.data.imagenFirma.base64} onUploadComplete={this.onFirmaUpload} />
    };

    logoEditRender(e) {
        return <ImageUploader accept={".jpeg,.jpg,.png,.gif"} rowData={e} mimeType={e.data.imagenLogo ? e.data.imagenLogo.mimeType : "image/jpeg"} base64={e.data.imagenLogo && e.data.imagenLogo.base64} onUploadComplete={this.onLogoUpload} />
    };
