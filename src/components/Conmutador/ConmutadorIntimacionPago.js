...
import { ConmutadorIntimacionPagoService } from '../../services/ConmutadorIntimacionPagoService';

import { menuCopiarATodos } from '../../utils/ProcesosGrid';

export class ConmutadorIntimacionPago extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            items: []
    ...
    refrescar() {
        ConmutadorIntimacionPagoService.listar(data => this.setState({ items: data }));
    }

    onRowUpdated(e) {
        ConmutadorIntimacionPagoService.modificar(e.data,
    ...
    modificarBatch(data, grid) {
        ...
        ConmutadorIntimacionPagoService.modificarBatch(data,
            (resp) => {
        ...
        return (
            <Fragment>
                ...
                >
                    ...
                    <Column dataField="imprimirIntimaciones" caption="Imprimir intimaciones" allowEditing={true} dataType={"boolean"} >
                    </Column>
